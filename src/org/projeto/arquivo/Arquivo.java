...
public class Arquivo {
	...
	public void Enviar(int quebrar, int envi) throws Exception {
		...
		BufferedInputStream bytes_arquivo = new BufferedInputStream(new FileInputStream(this.arquivo)); // Ler os bytes
																										// do arquivo
		int total = bytes_arquivo.read(this.bytes, 0, this.bytes.length); // Aqui estamos escrevendo os bytes do arquivo
																			// em nossa Array
